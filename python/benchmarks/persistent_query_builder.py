...
from framedb.storage_fixtures.s3 import real_s3_from_environment_variables
...
class PersistentQueryBuilderFunctions:
    ...
    def __init__(self):
        self.ac = real_s3_from_environment_variables(shared_path=True).create_fixture().create_frame()
