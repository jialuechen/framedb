...
from framedb.util.test import assert_frame_equal, assert_series_equal
from framedb.util._versions import IS_PANDAS_TWO
from framecc.pb2.descriptors_pb2 import TypeDescriptor
...
# https://github.com/man-group/FrameDB/issues/767
...
def test_update_with_empty_series_or_dataframe(lmdb_version_store, PandasType, assert_pandas_container_equal):
    # Non-regression test for https://github.com/man-group/FrameDB/issues/892
    lib = lmdb_version_store
...
def test_update_with_empty_dataframe_with_index(lmdb_version_store):
    # Non-regression test for https://github.com/man-group/FrameDB/issues/940
    lib = lmdb_version_store
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # For rationale see: https://github.com/man-group/FrameDB/pull/1049
...
def test_empty_column_handling(lmdb_version_store, input_empty_col_dtype, output_empty_col_dtype, value_type, size_bits):
    # Non-regression test for https://github.com/man-group/FrameDB/issues/987
    lib = lmdb_version_store
...
def test_date_range_multi_index(lmdb_version_store):
    # Non-regression test for https://github.com/man-group/FrameDB/issues/1122
    lib = lmdb_version_store
