...
from framedb.exceptions import SortingException
...
def test_datetimes_to_nats(lmdb_version_store):
    ...
    if IS_PANDAS_TWO:
        # In Pandas < 2.0, `datetime64[ns]` was _always_ used. `datetime64[ns]` is also used by FrameDB.
...
@pytest.mark.xfail(reason="See https://github.com/man-group/FrameDB/issues/1250")
@pytest.mark.parametrize("append", (True, False))
