...
from framedb.exceptions import ArcticDbNotYetImplemented, ArcticException
from framedb.version_store._custom_normalizers import (
    register_normalizer,
...
from framedb.version_store._common import TimeFrame
...
from framedb.util._versions import IS_PANDAS_ZERO, IS_PANDAS_TWO
...
def test_fails_humongous_meta():
    with pytest.raises(ArcticDbNotYetImplemented):
        from framedb.version_store._normalization import _MAX_USER_DEFINED_META as MAX
...
def test_pyarrow_error(lmdb_version_store):
    error_msg_intro = "PyArrow-backed pandas DataFrame and Series are not currently supported by FrameDB."
