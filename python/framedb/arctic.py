...
from framedb.options import DEFAULT_ENCODING_VERSION, LibraryOptions
from framedb_ext.storage import LibraryManager
from framedb.exceptions import LibraryNotFound, MismatchingLibraryOptions
from framedb.version_store.library import ArcticInvalidApiUsageException, Library
from framedb.version_store._store import NativeVersionStore
from framedb.adapters.frame_library_adapter import ArcticLibraryAdapter
...
from framedb.adapters.in_memory_library_adapter import InMemoryLibraryAdapter
...
class Arctic:
    ...
    def __init__(self, uri: str, encoding_version: EncodingVersion = DEFAULT_ENCODING_VERSION):
        ...
        uri: str
            ...
            **Azure**
                ...
                It is based on the Azure Connection String, with additional options for configuring FrameDB.
                ...
                Additional options specific for FrameDB:
        ...
        >>> ac = adb.Arctic('azure://CA_cert_path=/etc/ssl/certs/ca-certificates.crt;BlobEndpoint=https://frame.blob.core.windows.net;Container=acblob;SharedAccessSignature=sp=sig')
    ...
    def get_library(
        ...
        Examples
        --------
        >>> frame = adb.Arctic('s3://MY_ENDPOINT:MY_BUCKET')
        >>> frame.create_library('test.library')
        >>> my_library = frame.get_library('test.library')
        >>> my_library = frame['test.library']
