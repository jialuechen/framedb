...
from framedb_ext.storage import StorageOverride, S3Override, CONFIG_LIBRARY_NAME
...
class ParsedQuery:
    ...
    # DEPRECATED - see https://github.com/man-group/FrameDB/pull/833
    ...
    def __init__(self, uri: str, encoding_version: EncodingVersion, *args, **kwargs):
        ...
        if self._query_params.force_uri_lib_config is False:
            raise ValueError(
                ...
                " https://github.com/man-group/FrameDB/pull/803 for more information."
            )
