...
from framedb.log import storage as log
...
from framedb_ext.storage import StorageOverride, LmdbOverride, CONFIG_LIBRARY_NAME
from framedb.encoding_version import EncodingVersion
from framedb.exceptions import ArcticDbNotYetImplemented, LmdbOptionsError
    ...
    for key in parsed_query.keys():
        ...
        if key == "map_size":
            ...
            raise ArcticDbNotYetImplemented(
                ...
                "FrameDB. Please report on FrameDB Github."
            )
