    ...
    def __init__(
        ...
        *,
        ...
        dynamic_schema: bool, default False
            ...
            When disabled, FrameDB will tile stored data across both the rows and columns. This enables highly efficient
            ...
            When enabled, FrameDB will only tile across the rows of the data. This will result in slower column
        ...
        dedup: bool, default False
            ...
            all segments occuring after that modification will almost certainly differ. FrameDB creates new segments at
