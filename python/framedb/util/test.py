...
from framedb.log import configure, logger_by_name
from framedb.util._versions import PANDAS_VERSION, CHECK_FREQ_VERSION
from framedb.version_store import NativeVersionStore
from framedb.version_store._custom_normalizers import CustomNormalizer
from framecc.pb2.descriptors_pb2 import NormalizationMetadata
from framecc.pb2.logger_pb2 import LoggerConfig, LoggersConfig
from framecc.pb2.storage_pb2 import LibraryDescriptor, VersionStoreConfig
from framedb.version_store.helper import ArcticFileConfig
from framedb.config import _DEFAULT_ENVS_PATH
from framedb_ext import set_config_int, get_config_int, unset_config_int
...
def distinct_timestamps(lib: NativeVersionStore):
    """Ensures the timestamp used by FrameDB operations before, during and leaving the context are all different.
...
def random_seed_context():
    seed = os.getenv("FRAMEDB_RAND_SEED")
