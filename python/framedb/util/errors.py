...
import framedb_ext.exceptions as _cpp
...
# Not using framedb.log because framedb.__init__.py practically loads everything
from framedb_ext.log import log as _log, LogLevel as _LogLevel, LoggerId as _LoggerId
...
def framedb_raise(error_code: ErrorCodeEnumBase, error_msg_provider: Callable[[], str]):
