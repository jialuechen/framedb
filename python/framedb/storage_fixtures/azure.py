...
from framedb.version_store.helper import add_azure_library_to_env
...
class AzureContainer(StorageFixture):
    ...
    def _set_uri_and_client(self, auth: str):
        ...
        self.client = ContainerClient.from_connection_string(self.frame_uri, self.container, **policy)
...
class AzuriteStorageFixtureFactory(StorageFixtureFactory):
    ...
    # See more on https://github.com/man-group/FrameDB/issues/514
    ca_cert_path = ""
