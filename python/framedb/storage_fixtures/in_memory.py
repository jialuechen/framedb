...
from .api import *
from framedb.version_store.helper import add_memory_library_to_env
from framedb.adapters.in_memory_library_adapter import InMemoryLibraryAdapter
from framedb_ext.version_store import PythonVersionStore


class InMemoryStorageFixture(StorageFixture):
    frame_uri = InMemoryLibraryAdapter.REGEX
