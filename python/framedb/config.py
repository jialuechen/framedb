...
from framecc.pb2.logger_pb2 import LoggersConfig, LoggerConfig
from framecc.pb2.config_pb2 import RuntimeConfig
from framecc.pb2.storage_pb2 import EnvironmentConfigsMap, EnvironmentConfig, LibraryConfig, LibraryDescriptor
...
from framedb.log import logger_by_name, configure

_HOME = osp.expanduser("~/.frame/native")
...
def frame_native_path(p=None):
    return _expand_path(osp.join(_HOME, p)) if p else _HOME


_LOCAL_ENV = "local"
_DEFAULT_ENV = _LOCAL_ENV
_DEFAULT_ENVS_PATH = frame_native_path("conf/envs.yaml")
_DEFAULT_LMDB_LIB = "lmdb.default"
_DEFAULT_LOG_CONF = frame_native_path("conf/loggers.yaml")
_DEFAULT_LOG_DIR = frame_native_path("logs")
_DEFAULT_LOG_LEVEL = "INFO"
_DEFAULT_RUNTIME_CONF = frame_native_path("conf/runtime.yaml")
_DEFAULT_DATA_DIR = frame_native_path("data")
