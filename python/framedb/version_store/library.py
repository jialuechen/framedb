...
from framedb.supported_types import Timestamp
from framedb.util._versions import IS_PANDAS_TWO

from framedb.version_store.processing import QueryBuilder
from framedb.version_store._store import NativeVersionStore, VersionedItem, VersionQueryInput
from framedb_ext.exceptions import ArcticException
...
class WritePayload:
    ...
    One instance of ``WritePayload`` refers to one unit that can be written through to FrameDB.
    """
...
class WriteMetadataPayload:
    ...
    One instance of ``WriteMetadataPayload`` refers to one unit that can be written through to FrameDB.
    """
...
class Library:
    ...
    def __init__(self, frame_instance_description: str, nvs: NativeVersionStore):
        """
        Parameters
        ----------
        frame_instance_description
    ...
    def read(
        ...
        query_builder: Optional[QueryBuilder], default=None
            ...
            documentation for the QueryBuilder class (``from framedb import QueryBuilder; help(QueryBuilder)``).
